...
export default {
  ...
  data() {
    return {
      ...
      contentPairs: [
        {
          text: 'Experiencia similar a la de las principales aplicaciones comerciales de modelos de lenguaje natural.',
          video: 'https://videos.pexels.com/video-files/5636977/5636977-uhd_2560_1440_24fps.mp4',
        },
        {
          text: 'Todos los principales proveedores de modelos disponibles en una misma plataforma.',
          video: 'https://videos.pexels.com/video-files/1797251/1797251-uhd_2560_1440_24fps.mp4',
        },
        {
          text: 'Integración con algoritmos propios especializados en temas legales, fiscales y legislativos.',
